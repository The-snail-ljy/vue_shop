                          ...
                          <el-col :span="19">
                              ...
                              <!-- 二级权限 -->
                                  ...
                                  <el-col :span="18">
                                      ...
                                      type="warning" v-for="(item3) in item2.children" :key="item3.id">{{item3.authName}}</el-tag>
                                  </el-col>
                              </el-row>
                          </el-col>
                      </el-row>
...
export default {
    ...
    methods: {
        ...
        //通过递归的方式获取角色下三级权限的id 并储存到defKeys中
        getLeafKeys(node, arr) {
            //如果当前节点不包含children属性的 则是三级节点 将id push进arr数组里
            if(!node.children) {
        ...
        //监听权限对话框的关闭事件  使defKeys数组为空，避免之前保存的权限数据影响另一个权限数据
